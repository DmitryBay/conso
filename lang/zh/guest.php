...
return [
    ...
    'bill_title' => '房间账单', 'bill_eyebrow' => '整个入住期间', 'bill_intro' => '此处仅显示计入房账的服务。', 'guest' => '宾客', 'not_specified' => '未填写', 'bill_empty' => '暂无房账费用', 'bill_empty_hint' => '选择记入房账后将显示金额。', 'grand_total' => '应付金额', 'usd_estimate' => '折合美元约', 'rate_note' => '美元换算仅供参考，最终以酒店基础货币结算。', 'cancelled_excluded' => '已取消的请求不计入金额。', 'cash_excluded' => '现金支付的服务不计入房间账单。',
