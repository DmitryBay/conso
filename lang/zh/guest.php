...
return [
    ...
    'current_status' => '当前状态', 'status_title' => '请求状态', 'team_received' => '酒店团队已收到您的请求。', 'accepted_hint' => '工作人员已接单，将很快开始处理。', 'progress_hint' => '您的请求正在处理中。', 'waiting_hint' => '酒店团队正在等待您的操作或确认。', 'ready_hint' => '您的订单已准备好。请确认收到以完成请求。', 'completed_hint' => '您已确认请求完成。', 'cancelled_hint' => '此请求已取消，请联系前台了解详情。', 'order_contents' => '请求详情', 'created_at' => '创建于 :date', 'progress' => '处理进度', 'updated_by_team' => '由酒店团队更新', 'created_via_catalog' => '通过服务目录创建', 'need_help' => '需要帮助？', 'help_hint' => '请使用客房电话联系前台。',
    'status' => ['new' => '新请求', 'accepted' => '已接受', 'in_progress' => '处理中', 'waiting_guest' => '等待宾客', 'ready' => '已准备好', 'completed' => '已完成', 'cancelled' => '已取消'],
