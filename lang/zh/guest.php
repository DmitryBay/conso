...
return [
    ...
    'work_progress' => '工作进度', 'progress_percent' => '已完成 :percent%', 'progress_waiting' => '等待您的操作', 'progress_cancelled' => '工作已取消',
    'progress_steps' => ['received' => '已收到', 'accepted' => '已接受', 'working' => '处理中', 'ready' => '已就绪', 'completed' => '已完成'],
