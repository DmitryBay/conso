...
<head>
    <meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><meta name="csrf-token" content="{{ csrf_token() }}"><meta name="current-company-id" content="{{ $currentCompany->id }}"><meta name="admin-live-status-url" content="{{ route('workspace.live-status') }}"><meta name="app-version" content="{{ \App\Support\AppVersion::current() }}"><meta name="theme-color" content="#183c36"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-title" content="Luma Workspace"><meta name="webpush-public-key" content="{{ config('webpush.vapid.public_key') }}"><meta name="webpush-store-url" content="{{ route('workspace.push-subscriptions.store') }}"><meta name="webpush-test-url" content="{{ route('workspace.push-subscriptions.test') }}"><meta name="webpush-service-worker" content="/workspace-sw.js"><meta name="webpush-scope" content="/workspace/"><link rel="icon" type="image/svg+xml" href="{{ asset('favicon.svg') }}?v=2"><link rel="apple-touch-icon" sizes="180x180" href="{{ asset('app-icons/luma-180.png') }}"><link rel="manifest" href="{{ asset('workspace.webmanifest') }}">
...
@include('layouts.partials.app-update', ['title' => __('workspace.app_update_title'), 'message' => __('workspace.app_update_message'), 'action' => __('workspace.app_update_action')])
@stack('modals')
@stack('scripts')
</body></html>
