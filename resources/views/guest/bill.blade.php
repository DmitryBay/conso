...
<section class="guest-bill-paper">
    ...
    @endif
    <div class="bill-note"><i class="bi bi-info-circle"></i><span>{{ __('guest.rate_note') }} {{ __('guest.cancelled_excluded') }} {{ __('guest.refunded_excluded') }} {{ __('guest.cash_excluded') }}</span></div>
</section>
@endsection
